  ...
  const renderProductRow = (product: Product) => (
    ...
    >
      ...
      <td className="hidden md:table-cell px-6 py-4">
        <span className="text-xs font-bold text-brand-secondary capitalize">{product.category}</span>
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="lg:w-2/3">
           <div className="bg-white rounded-[2.5rem] shadow-xl border border-white overflow-hidden">
              ...
              <div className="px-6 py-4 bg-white border-b border-purple-50 overflow-x-auto">
                    ...
                    {allCategories.map(cat => (
                       <button
                          ...
                          className={`px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all ${
                             ...
                             : 'bg-brand-bg text-brand-primary hover:bg-purple-100'
                          }`}
                       >
                          {cat === 'all' ? 'TODOS' : cat}
                       </button>
                      ...
                      {Object.entries(groupedProducts).map(([category, prods]) => (
                        <div key={category}>
                           <div className="bg-brand-bg/50 px-6 py-3 flex items-center justify-between border-y border-purple-50">
                              <h4 className="text-[10px] font-black text-brand-secondary uppercase tracking-[0.3em]">{category}</h4>
